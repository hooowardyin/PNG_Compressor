...
public final class HuffmanCompress {
	...
	public static void main(String[] args) throws IOException {
		...
		// Otherwise, compress
		doHuffmanCompress(args[0], args[1]);
	}
	
	// hack by greg to get this thing to work w/ our stats collecting...
	public static void doHuffmanCompress(String inFile, String outFile) throws IOException {
